...
# yelp_restaurants = {"yelp-restaurants":restaurants}
# Y = json.dumps(yelp_restaurants)
# print("no of items in res {}".format(len(restaurants)))
# print("type of Y  {}".format(type(Y)))
# print(Y)
#
# # print(files)
# # restaurants = []
# # for i in range(0,len(files['businesses'])):
# #     restaurants.append(files['businesses'][i]['alias'])
# #
# # for item in restaurants :
# #     print("alias = "+item)
#
# businesses = files['businesses']
# #y = json.loads(businesses)
# print(businesses)
...
#print(files)
    ...
    # print("no of items in res {}".format(len(restaurants)))
    # print(restaurants)
    # print(insert_record(restaurants,client,table_name))
    #
    #
